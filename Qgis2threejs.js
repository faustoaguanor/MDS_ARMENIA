  ...
  (function () {
    ...
    app.measure = {
      ...
      showResult: function () {
        ...
        html += "<tr><td>Diferencia vertical:</td><td>" + this.formatLength(dz) + ' m</td><td><span class="tooltip tooltip-btn" data-tooltip="diferencia de elevación entre el punto de inicio y el punto final">?</span></td></tr>';
        html += "</table>";
